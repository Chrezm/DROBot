    ...
    def __init__(self, bot: commands.Bot = None, guild_details: Dict = None):
        ...
        @bot.command(
            ...
            help=('Lists the time based on <important> timezones. Date format: YYYY-MM-DD.'
                  ...
                  '\nExample: $timezone HN'
                  '\n\n<seconds> is an optional field; it is an epoch/unix second argument. It can '
                  'also be an RP Serial Code.'
                  "\nInputting <seconds> as an RP Serial Code will return you said RP's First Session "
                  "Date."
                  )
        )
        async def timezone(ctx: commands.Context, seconds=None):
            ...
            await times.command_timezone(bot, guild_details, ctx, seconds=seconds)
        ...
        async def utc(ctx: commands.Context, seconds=None):
            ...
            await times.command_utc(bot, guild_details, ctx, seconds=seconds)
